    ...
    >
      ...
      <div className="flex justify-between w-1/3 h-3/5">
        ...
        <Link href="/auth/signin">
          <button className="border-0 rounded-lg p-4 bg-gradient-to-r from-teal-700 hover:bg-gradient-to-r hover:from-black hover:via-green-700 hover:to-green-500 text-xl">
            Sign In
          </button>
        </Link>
      </div>
